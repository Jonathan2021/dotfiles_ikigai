...
(( i=i+1 ));tput cup $i $((35 + shiftl));printf " \e[0m  Hello \e[36m$name\033[0m, I'm \e[34m$host\n" | lolcat -a -d 30 
(( i=i+1 ));tput cup $i $((40 + shiftl));printf " \e[0m\n"

#█▓▒░ environment
(( i=i+1 ));tput cup $i $((36 + shiftl));printf " \e[1;33m      distro";tput cup $i 53;printf " \e[0m$distro\n";sleep 0.1
(( i=i+1 ));tput cup $i $((36 + shiftl));printf " \e[1;33m      kernel";tput cup $i 53;printf " \e[0m$kernel\n";sleep 0.1
(( i=i+1 ));tput cup $i $((38 + shiftl));printf " \e[1;33m    packages";tput cup $i $((53 + shiftl));printf " \e[0m$pkgs\n";sleep 0.1
(( i=i+1 ));tput cup $i $((32 + shiftl));printf " \e[1;33m          wm";tput cup $i $((52 + shiftl));printf "  \e[0m$wm\n";sleep 0.1
#(( i=i+1 ));tput cup $i $((50 + shiftl));printf " \e[1;33m        font \e[0m$font\n"
#(( i=i+1 ));tput cup $i $((50 + shiftl));printf " \e[1;33m      colors \e[0m$colors\n"
(( i=i+1 ));tput cup $i $((36 + shiftl));printf " \e[0m\n"

#█▓▒░ cpu
cpu=$(grep 'cpu ' /proc/stat | awk '{usage=($2+$4)*100/($2+$4+$5)} END {print usage}')
(( i=i+1 ));tput cup $i $((39 + shiftl));
c_lvl=`printf "%.0f" $cpu`
tput cup $i $((39 + shiftl));printf "   \e[0;36m%-4s \e[1;36m%-5s %-25s \n" " cpu" "$c_lvl%" `draw $c_lvl 15` ;sleep 0.2

#█▓▒░ ram
ram=`free | awk '/Mem:/ {print int($3/$2 * 100.0)}'`
(( i=i+1 ));tput cup $i $((39 + shiftl));printf "   \e[0;36m%-4s \e[1;36m%-5s %-25s \n" " ram" "$ram%" `draw $ram 15` ;sleep 0.2
...
(( i=i+1 ));tput cup $i $((39 + shiftl));printf "   \e[0;${color}m%-4s \e[1;${color}m%-5s %-25s \n" " vol" "$vol%" `draw $vol 15 $color` ;sleep 0.2
...
(( i=i+1 ));tput cup $i $((40 + shiftl));printf "   \e[0;${color}m%-4s \e[1;${color}m%-5s %-25s \n\n" "temp" "$temp°c " `draw $temp 15 $color`;sleep 0.2

#█▓▒░ colors
printf "\n"
sleep 1;
(( i=i+1 )); tput cup $i $((0 + shiftl)); bash ~/dotfiles_ikigai/scripts/color_inline.sh
