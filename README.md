...
all the above mentioned are necessary for proper working and usage of my config. most of packages could be easily installed, but finding some of those is a bit tricky. so here are the links to applications which i found hard to find in the first place :)  
